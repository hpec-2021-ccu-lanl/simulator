...
for exp in experiments:
    ...
    normalized_makespans[exp]=[averages[1]/averages[0],averages[2]/averages[0]]
for key,value in normalized_makespans.items():
    print("\nExperiment: "+key+":",flush=True)
    print("2x: "+str(value[0])+ "  5x: "+str(value[1]),flush=True)
    print("\n",flush=True)
